#ifndef HALIDE__halide_test_h
#define HALIDE__halide_test_h
#include <stdint.h>
...
int halide_test(struct halide_buffer_t *_weights_buffer, struct halide_buffer_t *_input_buffer, int32_t _size, int32_t _stride, bool _pad, int32_t _outx, int32_t _outy, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int halide_test_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *halide_test_metadata() HALIDE_FUNCTION_ATTRS;

int halide_test_old_buffer_t(struct buffer_t *_weights, struct buffer_t *_input, int32_t _size, int32_t _stride, bool _pad, int32_t _outx, int32_t _outy, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
